    ...
    <div id="mc_embed_signup">
        <form action="//ngomik.us4.list-manage.com/subscribe/post?u=de381d4cdac3d2826f5e4df67&amp;id=ea69cd49d9"
            ...
            <div id="mc_embed_signup_scroll">
                <h2>Daftar newsletter yuk!</h2>
                <p>Kamu akan mendapatkan maksimal 1 email per minggu, berisi kumpulan informasi menarik seputar Laravel, PHP, dan teknologi web pada umumnya.</p>
                <p>1000++ web artisan lain telah berlangganan, jangan kudet.</p>
                <div class="mc-field-group">
                    <label for="mce-EMAIL">Email </label>
                    <input type="email" value="" name="EMAIL" class="required email" id="mce-EMAIL" placeholder="Masukkan email">
                </div>
                ...
                <div class="clear"><input type="submit" value="Berlangganan" name="subscribe" id="mc-embedded-subscribe" class="button"></div>
            </div>
        </form>
